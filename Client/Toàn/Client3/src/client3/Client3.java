...
class ConnectThread extends Thread {
    ...
    private int port;
    private int type;
    private String path = "C:\\Users\\banhb\\Desktop\\LTM\\NetProgramming\\Client\\Toàn\\Client3\\listFiles";
        ...
        try {
            ...
            while (true) {
                ...
                if (type == 5) {
                    ...
                    File dir = new File("/home/tranquangtoan/NetBeansProjects/Client3/listFiles");
                    File[] listFile = dir.listFiles();
                    File file = new File("/home/tranquangtoan/NetBeansProjects/Client3/listFiles/"+fileName);
